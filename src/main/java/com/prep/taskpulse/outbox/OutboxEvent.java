...
public class OutboxEvent {
    ...
    private OutboxEvent(UUID id, String aggregateType, UUID aggregateId,
                       String eventType,String partitionKey ,String payload,
                       Instant occurredAt) {
        this.id = id;
    ...
    public static OutboxEvent create(String aggregateType, UUID aggregateId
                                    ,String eventType, String partitionKey ,String payload, Instant occurredAt){

        return new OutboxEvent(UUID.randomUUID(), aggregateType, aggregateId, eventType, partitionKey,payload,occurredAt);
    }
