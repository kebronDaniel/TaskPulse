...
public class Task extends BaseEntity {
  ...
  private Task(
      String title, String description, Project project, TaskPriority priority, Instant dueDate) {
  ...
  public void changeStatus(TaskStatus status) {
    ...
    if (this.status == TaskStatus.DONE && status == TaskStatus.TODO)
      throw new IllegalArgumentException("Completed task cannot be reopened directly");
    this.status = status;
  }
