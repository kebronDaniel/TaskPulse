...
public interface TaskRepository extends JpaRepository<Task, UUID>, JpaSpecificationExecutor<Task> {
  ...
  Optional<Task> findWithProjectAndAssigneeByIdAndProjectIdAndDeletedAtIsNull(
  ...
  // DTO projection (join fetch without the fetch because you don't need to fetch and process
  // project or user)
  @Query(
      """
