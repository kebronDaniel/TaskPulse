...
public class TaskOptimisticLockIntegrationTest {
    ...
    private Task createPersistedTask(){
        ...
        User user = User.createUser("Joseph","joseph-" + UUID.randomUUID() + "@gmail.com","testpasswordhash", Role.USER);
    ...
    void concurrentUpdates_whenSecondTransactionUsesStaleVersion_throwsOptimisticLockException(){
        ...
        try {
            ...
            Task persistedTask = taskRepository.findById(taskId).orElseThrow(); // this uses a separate entity manager.
