...
class OutboxEventProcessorTest {
    ...
    void processEvent_whenKafkaIsUp_publishesEventAndMarksEventAsPublished(){
        OutboxMessage message = new OutboxMessage(UUID.fromString("123e4567-e89b-12d3-a456-426614174111")
                ,"123e4567-e89b-12d3-a456-426614174222","Payload");
    ...
    void process_whenPublishFails_recordsFailureWithoutDeferring(){
        ...
        verify(outboxStatusService).recordFailure(eq(message.eventId()),contains("Connection timeout"));
